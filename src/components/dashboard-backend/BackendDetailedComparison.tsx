...
import { ArrowUp, ArrowDown, Minus, Code, Users, Flag, Layers, Sparkles } from "lucide-react";
...
interface BackendDetailedComparisonProps {
    title: string;
    subtitle: string;
        ...
        >
            ...
            <div className="relative flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">{data.length} itens ativos</p>
                    </div>
                </div>
            ...
            <div className="relative mb-4 p-4 rounded-xl bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border border-primary/20">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Code className={`w-5 h-5 ${iconColor}`} />
                        <span className="font-semibold text-foreground">Total de Entregas</span>
                    </div>
            ...
            {topItem && (
                <div className={`mb-4 p-3 rounded-xl bg-gradient-to-r ${gradientFrom} ${gradientTo} bg-opacity-20`}>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-white/80 font-semibold">{topItem.novembro} entregas</span>
                    </div>
                </div>
            )}
